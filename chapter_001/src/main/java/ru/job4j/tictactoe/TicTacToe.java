...
/**
 * Class TicTacToe решение задачи части 001 - урок Крестики-нолики на JavaFX, реализует визуальный компонент.
 * @author vmyaskovskiy
 * @version $Id$
 * @since 0.1
 */
...
public class TicTacToe extends Application {
    ...
    private void checkWinner() {
        if (this.logic.isWinnerXNew()) {
            this.showAlert("Победили Крестики! Начните новую Игру!");
        } else if (this.logic.isWinnerONew()) {
