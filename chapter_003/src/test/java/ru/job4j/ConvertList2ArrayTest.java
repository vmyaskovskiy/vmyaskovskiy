...
public class ConvertList2ArrayTest {
    ...
    public void when7ElementsThen9() {
       ConvertList2Array res = new ConvertList2Array();
        int[][] result = res.toArray(List.of(1, 2, 3, 4, 5, 6, 7), 3);
        int[][] expect = {
                {1, 2, 3},
                {4, 5, 6},
                {7, 0, 0}
    ...
    public void when5ElementsThen6() {
        ConvertList2Array res = new ConvertList2Array();
        int[][] result = res.toArray(List.of(1, 2, 3, 4, 5), 2);
        int[][] expect = {
                {1, 2, 3},
                {4, 5, 0}
        };
    ...
    public void when6ElementsThen6() {
        ConvertList2Array res = new ConvertList2Array();
        int[][] result = res.toArray(List.of(1, 2, 3, 4, 5, 6), 2);
        int[][] expect = {
                {1, 2, 3},
                {4, 5, 6}
        };
    ...
    public void when6ElementsThen8and4Rows() {
        ConvertList2Array res = new ConvertList2Array();
        int[][] result = res.toArray(List.of(1, 2, 3, 4, 5, 6), 4);
        int[][] expect = {
                {1, 2},
                {3, 4},
                {5, 6},
    ...
    public void convertToListTest() {
        ...
        List<int[]> list = List.of(
                ...
                new int[] {1, 2, 3},
                new int[] {0, 5, 6, 4, 8});
        List<Integer> expect = List.of(1, 2, 1, 2, 3, 0, 5, 6, 4, 8);
